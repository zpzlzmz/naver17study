...
<body>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="text" class="form-control" id="maddr"
						value="${dto.maddr }"> <br>
					<button type="button" class="btn btn-sm btn-success" id="btnupdate"
	...
	<div style="margin: 30px 100px;">
		...
		<img src="${naverurl }/member/${dto.mphoto}" class="profilelargephoto"
			onerror="this.src='${root}/noimage.png'"> <input type="file"
			id="fileupload" style="display: none;"> <i
			class="bi bi-camera2 changecamera"></i>
		<script type="text/javascript">
		...
		<div style="display: inline-block; margin: 20px 50px;">
			...
			<button type="button" class="btn btn-sm btn-danger"
				onclick="memberdel(${dto.num})">회원 탈퇴</button>
			<script type="text/javascript">
